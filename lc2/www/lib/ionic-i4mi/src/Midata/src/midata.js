  ...
  return {
    ...
    link: function(scope, element, attrs) {
      $ionicPlatform.ready(function() {
        ...
        I4MIHealthKitService.readWeight({
          unit: 'kg'
        }).then(function(entry) {
        ...
        I4MIHealthKitService.readHeight({
          unit: 'cm'
        }).then(function(entry) {
          entry.amount = entry.value;
          entry.unit = "cm";
...
.service('I4MIHealthKitService', ['I4MIModalService', '$q', function(I4MIModalService, $q) {
  ...
  return {
    available: function() {
      return typeof plugins.healthkit !== 'undefined'
    },
...
.service('I4MIMidataService', ['I4MIModalService', 'I4MISettingsService', '$q', '$http', '$crypto', 'APPNAME', 'APPSECRET', function(I4MIModalService, I4MISettingsService, $q, $http, $crypto, APPNAME, APPSECRET) {
  ...
  var push = function(action, entries, index) {
    return $q(function(resolve, reject) {
      ...
      $http({
        method: 'POST',
        url: midata.server + '/v1/records/' + action,
        data: data
      }).then(function successCallback(response) {
        if (typeof response.status === 'undefined' || response.status != 200) {
  ...
  return {
    ...
    search: function(fields, properties) {
      ...
      return $q(function(resolve, reject) {
        $http({
          method: 'POST',
          url: midata.server + '/v1/records/search',
          data: {
